...
myfile =  open('file-manipulation-read.txt')
...
with open('file-manipulation-read.txt', mode='r') as my_new_file:
    contents = my_new_file.read()

print(contents)

# writing to a new file
with open('file-manipulation-write.txt', mode='w') as myfile:
    contents = myfile.write('Welcome to the new file! Please refer to file-manipulation.py')
    # myfile.read() this will throw an error

# append only - good for logs
with open('file-manipulation-write.txt', mode='a') as myfile:
    contents = myfile.write('\nTHIS WAS APPENDED')
    # myfile.read() this will throw an error

# reading and writing to an existing file
with open('file-manipulation-write.txt', mode='r+') as myfile:
    contents = myfile.write('...OVERWRITTEN...')
    myfile.read() # all good we can read too.

# writing a new file and allows reading
with open('file-manipulation-overwrite.txt', mode='w+') as myfile:
